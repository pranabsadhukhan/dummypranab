<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      ...
      if(isset($result_edit->gallery_id) && $result_edit->gallery_id !=""){
        $hidden = array('flag' => 'add','gallery_id' => $result_edit->gallery_id);
        echo form_open('administrator/updategallery', $attributes,$hidden);
      }else{
        $hidden = array('flag' => 'add');
        echo form_open('administrator/addgallery', $attributes,$hidden);
      }
      ?>
          <div class="box-body">
  ...
  <div class="form-group">
              ...
              <input type="file" name="gallery_pic" id="gallery_pic" />
              <?php
        if(isset($result_edit->gallery_pic) && $result_edit->gallery_pic != ""){
        ?>
              <img src="<?php echo site_url($result_edit->gallery_pic); ?>" width="100" />
              <?php 
        }
        ?>
            </div>
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                     <?php
          $i = 1;
          if(isset($gallery_num) && $gallery_num > 0){
            foreach($gallery_log as $keypic => $valpic){
            $edit_id = $valpic->gallery_id;
          ?>
                    <tr>
                        <td><?php echo $i; ?></td>
                        ...
                        <!-- <td><img src="<?php if(isset($valpic->testimonial_pic)){echo site_url($valpic->testimonial_pic);}else{echo site_url('uploads/no_image.jpg');} ?>" width="50" /></td> -->
                         ...
                         <td><img src="<?php if(isset($valpic->gallery_pic) && $valpic->gallery_pic != ""){echo site_url($valpic->gallery_pic);}else{echo site_url('uploads/no_image.jpg');} ?>" width="100"></td>
                        ...
                        <td class="table-actions">
                            <a href="<?php echo site_url('administrator/editgallery/'.$edit_id) ?>" title="Edit" class="with-tip"><i class="fa fa-edit"></i> Edit</a>
                           <a href="<?php echo site_url('administrator/deletegallery/'.$edit_id) ?>" title="Delete" class="with-tip" onclick="return confirm('Are you sure want to permanently block this?');"><i class="ion-trash-b"></i> Delete</a>
                        </td>
                    </tr>
                    <?php
              $i++;
