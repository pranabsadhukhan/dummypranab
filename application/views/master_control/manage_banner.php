            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				if(isset($result_edit) && $result_edit->banner_id > 0){
					...
					echo form_open('administrator/updatebanner', $attributes,$hidden);
				}else{
				...
				?>
                  <div class="box-body">
                    ...
                    <label for="page_id">Banner Type</label>
                    <select name="page_id" id="page_id" class="form-control">
                    <option value="1" <?php if(isset($result_edit) && $result_edit->page_id == 1){echo "selected";}?>>Top Sliding Main Banner </option>
                    </select>
                    </div>
                    <div class="form-group">
...
<!--                  <div class="alert alert-info alert-dismissable">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td><?php echo $i; ?></td>
                        <td><?php if($valpic->page_id == 1){echo "Top Sliding Main Banner";}elseif($valpic->page_id == 10){echo "Mobile Sliding Main Banner";} ?></td>
                        ...
                        <td class="table-actions">
                            <a href="<?php echo site_url('administrator/editbanner/'.$edit_id) ?>" title="Edit" class="with-tip"><i class="fa fa-edit"></i> Edit</a>
                           <a href="<?php echo site_url('administrator/deletebanner/'.$edit_id) ?>" title="Delete" class="with-tip" onclick="return confirm('Are you sure want to permanently block this?');"><i class="ion-trash-b"></i> Delete</a>
                        </td>
                    </tr>
                    <?php
							$i++;
