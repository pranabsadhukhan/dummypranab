  <div class="banner-inner" style="background-image: url('<?php if(isset($banner_log->banner_pic) && $banner_log->banner_pic != ""){echo site_url($banner_log->banner_pic);} ?>')">
        <div class="breadcrumb-sec">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('climatechangecause');?>">Climate Change Causes</a></li>
            </ol>   
        </div>
    </div>
          ...
          <div class="climate-change">
            <div class="clearfix">
                <div class="climate-change-pic">
                    <img src="<?php echo base_url($climate2->pic); ?>">
                </div>
                <div class="climate-change-text">
                    <h4><?php echo $climate2->name; ?></h4>
                    <?php echo $climate2->description; ?>
                </div>
            </div>
          </div>
